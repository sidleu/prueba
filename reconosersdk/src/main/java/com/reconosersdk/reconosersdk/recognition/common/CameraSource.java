...
public class CameraSource {
    ...
    private FaceDetectorMl frameProcessor;
    public int angle;
    ...
    public synchronized void setFacing(int facing) {
        //Is always true on most phones, but if the camera comes from a USB or Bluetooth source
    ...
    /**
     * Changes the flash of the camera.
     */
    ...
    private Camera createCamera() throws IOException {
        ...
        //If the camara is front(1) or back(0)
        if ((requestedCameraId == CAMERA_FACING_FRONT || requestedCameraId == CAMERA_FACING_BACK )  && hasFlash) {
            ...
            if(supportedFlashModes != null) {
                if(supportedFlashModes.contains(Camera.Parameters.FLASH_MODE_TORCH)) {
                    ...
                    Timber.i("Camera flash is not supported on this device.");
                }
            }
        }
        parameters.setPreviewSize(previewSize.getWidth(), previewSize.getHeight());
        /* parameters.setPreviewSize(previewSize.getWidth(), 960);*/ //todo no se ven tan achatado en el samsung
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        this.angle = angle;
        Timber.w("camera rotation %1s",this.rotation);
    ...
    public void setMachineLearningFrameProcessor(FaceDetectorMl processor) {
        synchronized (processorLock) {
            cleanScreen();
            if (frameProcessor != null) {
                frameProcessor.stop();
