...
public class Imgproc {
    ...
    /**
     * Calculates the font_regular-specific size to use to achieve a given height in pixels.
     *
     ...
     * using the specified font_regular are replaced by question marks. See #getTextSize for a text rendering code
     * example.
     *
     * @param img Image.
     ...
     * @param fontScale Font scale factor that is multiplied by the font_regular-specific base size.
